...
const Navbar = () => {
  ...
  return (
    <nav className="flex justify-between bg-creamcolor dark:bg-transparent h-16 md:items-center text-neutral-900 dark:text-white px-10 pt-6 md:px-20 relative">
